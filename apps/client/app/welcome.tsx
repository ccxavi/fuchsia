...
import { FuchsiaGradient } from '@/constants/theme';
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.hero}>
        ...
        >
          <Image
            source={require('@/assets/images/fuchsia.png')}
        ...
        <View style={styles.headingGroup}>
          <Text style={styles.heading}>Fuchsia</Text>
          <Text style={styles.tagline}>Your new app starts here.</Text>
        </View>
      </View>
      ...
      <View style={styles.cta}>
        ...
        <Text style={styles.ctaCaption}>One-tap sign-in for Fuchsia.</Text>
      </View>
    </SafeAreaView>
  );
}
